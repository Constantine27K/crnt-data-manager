...
func RegisterSprintRegistryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SprintRegistryServer) error {
	...
	mux.Handle("POST", pattern_SprintRegistry_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/github.constantine27k.crnt_data_manager.api.sprint.SprintRegistry/Create", runtime.WithHTTPPathPattern("/v1/sprint/create"))
		if err != nil {
...
func RegisterSprintRegistryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SprintRegistryClient) error {
	...
	mux.Handle("POST", pattern_SprintRegistry_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/github.constantine27k.crnt_data_manager.api.sprint.SprintRegistry/Create", runtime.WithHTTPPathPattern("/v1/sprint/create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SprintRegistry_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "sprint", "create"}, ""))
)
