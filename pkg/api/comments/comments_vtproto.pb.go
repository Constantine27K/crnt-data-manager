...
func (m *Comment) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.WrittenAt != nil {
		if marshalto, ok := interface{}(m.WrittenAt).(interface {
			...
			encoded, err := proto.Marshal(m.WrittenAt)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *Comment) SizeVT() (n int) {
	...
	if m.WrittenAt != nil {
		if size, ok := interface{}(m.WrittenAt).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.WrittenAt)
		}
		n += 1 + l + sov(uint64(l))
	}
	if m.UpdatedAt != nil {
...
func (m *Comment) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.WrittenAt == nil {
				m.WrittenAt = &timestamppb.Timestamp{}
			}
			if unmarshal, ok := interface{}(m.WrittenAt).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.WrittenAt); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *Comments) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Items == nil {
				m.Items = make(map[int64]*Comment)
			}
			var mapkey int64
			var mapvalue *Comment
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
